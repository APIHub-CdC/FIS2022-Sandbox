...
public class RequestDatosGenerales {
  ...
  public RequestDatosGenerales colonia(String colonia) {
  ...
  @ApiModelProperty(required = true, value = "delegacion o Municipio")
  ...
  @ApiModelProperty(example = "11230.0", required = true, value = "codigo postal")
  public String getCp() {
    return cp;
  }
  ...
  @ApiModelProperty(example = "PUOJ940919488", required = true, value = "folio otorgante")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.primerNombre, requestDatosGenerales.primerNombre) &&
        ...
        Objects.equals(this.colonia, requestDatosGenerales.colonia) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(primerNombre, apellidoPaterno, apellidoMaterno, fechaNacimiento, direccion, colonia, ciudad, estado, pais, delegacionMunicipio, cp, rfc, folioOtorgante);
  }
  @Override
