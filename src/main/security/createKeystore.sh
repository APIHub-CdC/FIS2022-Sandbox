#!/bin/sh
export PRIVATE_KEY_FILE=/Users/ryperezr/Documents/Certificados_SSL/PRODUCCION/Circulo_Credito_Keys-20230914T130146/private_key.pem
export CERTIFICATE_FILE=/Users/ryperezr/Documents/Certificados_SSL/PRODUCCION/Circulo_Credito_Keys-20230914T130146/certificate.pem
export SUBJECT=/C=MX/ST=MX/L=MX/O=CDC/CN=CDC
export PKCS12_FILE=keypair.p12
export KEYSTORE_PASSWORD=password
export KEY_PASSWORD=password
export KEYSTORE_FILE=/Users/ryperezr/Documents/Certificados_SSL/PRODUCCION/Circulo_Credito_Keys-20230914T130146/keystore.jks
export ALIAS=cdc
